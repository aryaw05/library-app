        ...
        >
            ...
            >
                <a href="" class="flex items-center justify-center gap-2">
                    ...
                    />
                    <h1
                        class="text-sm md:text-lg text-white font-semibold burger"
                    >
                ...
                >
                            ...
                            @else
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <svg
                                            class="w-5 h-5 text-white dark:text-white md:hidden"
                                            aria-hidden="true"
                    ...
                    <button
                        ...
                        type="button"
                        class="burger inline-flex items-center p-2 w-10 h-10 justify-center text-sm rounded-lg md:hidden focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600 text-white"
                ...
                <div
                    class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1 overflow-hidden dark:md:bg-transparent dark:bg-gray-900"
                    id="navbar-cta"
                >
                    <ul
                        class="flex flex-col bg-white md:bg-transparent font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700"
                    >
                        <li>
                            <a
                                href="#"
                        ...
                        <li>
                            <a
                                href="#about"
                                class="block py-2 px-3 md:p-0 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 text-black md:text-white nav-text"
                            >
                                Tentang Sekolah
                            </a>
                        </li>
                        <li>
                            <a
                                href="#visi-misi"
                                class="block py-2 px-3 md:p-0 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 nav-text text-black md:text-white"
                            >
                                Visi & Misi
                            </a>
                        </li>
